        ...
        <div key={message.id} className="flex items-start gap-3 hover:bg-gray-50 px-2 py-1 rounded group">
          ...
          <div className="flex-1 relative">
            ...
            <button 
              ...
              className="absolute right-0 top-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-sm text-gray-500 hover:text-gray-700 bg-white px-3 py-1 rounded border border-gray-200 shadow-sm"
            >
              Reply to thread
            </button>
          </div>
